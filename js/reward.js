...
const Reward = {
	...
	archiveCompletedReward() {
		...
		State.progress.completedRewards.push({
			...
			// V28 : marque l'entrée comme non encore consultée depuis "Mes
			// récompenses", pour lui donner un badge "Nouveau" jusqu'à la
			// première ouverture. Absent (undefined) sur les sauvegardes
			// antérieures à V28 : traité comme déjà vu, jamais comme nouveau
			// (cf. RewardsList.show — on ne casse pas les sauvegardes, §12).
			viewed: false,
		});
	},
