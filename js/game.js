...
const Game = {
	...
	init() {
		...
		// V29 : même tutoriel que Réglages, ouvert directement depuis le
		// plateau — pas de contenu dupliqué (voir Settings.openHowTo).
		document.getElementById("btn-game-howto").addEventListener("click", () => Settings.openHowTo());
	},
	...
	show() {
		...
		document.getElementById("board-howto-label").textContent = Loc.t("board_howto_label");
