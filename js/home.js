...
const Home = {
	init() {
		...
		document.getElementById("btn-home-chat").addEventListener("click", () => {
			Audio_.playClick();
			Nav.push("chat");
		});
		...
		document.getElementById("home-hub-card").addEventListener("click", () => {
			Audio_.playClick();
			Nav.push("hub");
		});
	...
	showMenu() {
		...
		document.getElementById("home-hub-title").textContent = Loc.t("home_hub_title");
		document.getElementById("home-hub-subtitle").textContent = Loc.t("home_hub_subtitle");
