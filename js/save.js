...
const SaveManager = {
	...
	resetProgress() {
		...
		const playerId = State.profile.playerId; // identifiant Firebase : jamais réinitialisé avec la partie
		State.profile = { language, gender: "", avatar: "", playerName: "", playerId, onboardingDone: false, welcomeSeen: false };
		State.progress = {
